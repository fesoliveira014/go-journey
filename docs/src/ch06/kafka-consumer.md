...
Section 6.1 covered the theory of event-driven architecture. This section gets into the mechanical details: how the catalog service actually consumes reservation events from Kafka using the Sarama library's consumer group API.
