...
- [Chapter 13: Production Hardening](./ch13/index.md)
  - [13.2 DNS with Route 53](./ch13/dns.md)
  - [13.3 TLS with ACM](./ch13/tls.md)
  - [13.4 Secrets Management](./ch13/secrets.md)
  - [13.5 Kafka Encryption: MSK TLS](./ch13/msk-tls.md)
  - [13.6 Applying the Changes](./ch13/applying.md)
