...
func (c *authServiceClient) InitOAuth2(ctx context.Context, in *InitOAuth2Request, opts ...grpc.CallOption) (*InitOAuth2Response, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InitOAuth2Response)
	err := c.cc.Invoke(ctx, AuthService_InitOAuth2_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) CompleteOAuth2(ctx context.Context, in *CompleteOAuth2Request, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
...
func (UnimplementedAuthServiceServer) InitOAuth2(context.Context, *InitOAuth2Request) (*InitOAuth2Response, error) {
	return nil, status.Error(codes.Unimplemented, "method InitOAuth2 not implemented")
}
...
func _AuthService_InitOAuth2_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InitOAuth2Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).InitOAuth2(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_InitOAuth2_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).InitOAuth2(ctx, req.(*InitOAuth2Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "InitOAuth2",
			Handler:    _AuthService_InitOAuth2_Handler,
		},
		{
